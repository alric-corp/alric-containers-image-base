...
**Procedimento/autorização:** seguir o procedimento de renomeação,
...
| Segundo checkout usa token do próprio repo | Solução de leitura cross-repository segura se biblioteca for privada, em [ci.yml](../.github/workflows/ci.yml) | Decisão de visibilidade/acesso admins; sem secrets a PR/fork | CA-02 com limites de eventos documentados, falha fechada e sem ampliar executor; P0-03 |
