...
| [0007](0007-multi-source-alpine-dotnet8.md) | Fonte de pacotes por framework: Wolfi default, Alpine v3.24 como exceção governada do `dotnet8` (substitui a exclusão do ADR-0001) | Proposto | `policies/sources/package-sources.json`; `source_trust.py`; `sbom_completeness.py`; `distroless/sources/` |
